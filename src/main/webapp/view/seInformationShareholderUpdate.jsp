				...
				<div class="col-xs-10 prn" style="padding-left:0">
					...
					<div class="panel panel-default top-div">
						...
						<div class="panel01">
							...
							<form action="<%=basePath%>saveInformationShareholder.do" method="post" onsubmit="return doVaild()" style="margin-top:50px;">
							<input type="hidden" name="isId"
											value="${informationShareholder.isId}">
									...
									<div class="col-xs-6 mtm" style="padding-left:0px;">
										...
										<div class="col-xs-8"> 
											<div class="input-append date" id="datetimepicker" >
											       <input type="text" name="alterTime" class="form-control" value="<fmt:formatDate value="${informationShareholder.alterTime}" pattern="yyyy-MM-dd"/>" />
