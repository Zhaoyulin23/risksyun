				...
				<div class="col-xs-10 prn" style="padding-left:0">
					...
					<div class="panel panel-default top-div">
						...
						<div class="panel01">
							...
							<form action="<%=basePath%>saveInformationIpo.do" id="uploadForm" method="post" onsubmit="return doVaild()" style="margin-top:50px;">
							<input type="hidden" name="ipoId"
											value="${informationIpo.ipoId}">
								...
								<div class="form-group" style="margin-top:5px;text-align: right;">
									...
									<div class="col-xs-9 mtm" style="padding-left:0px;">
										<label class="col-xs-3 control-label" style="width: 120px;line-height:34px;vertical-align: middle;">
										 ...
										 <div class="col-xs-6">
											  <input type="text" name="exchange" class="form-control" value="${informationIpo.exchange}" />
										 </div>
									</div>
									...
									<div class="col-xs-9 mtm" style="padding-left:0px;">
										...
										<div class="col-xs-6"> 
											<div class="input-append date" id="datetimepicker" >
											       <input type="text" name="ipoDate" class="form-control" value="<fmt:formatDate value="${informationIpo.ipoDate}" pattern="yyyy-MM-dd"/>" />
									...
									<div class="col-xs-9 mtm" style="padding-left:0px;">
										...
										<div class="col-xs-6"> 
											<input type="text" name="ipoCode" id="ipoCode" class="form-control" value="${informationIpo.ipoCode}" />
										</div>
									</div>
