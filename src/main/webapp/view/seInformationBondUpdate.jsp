				...
				<div class="col-xs-10 prn" style="padding-left:0">
					...
					<div class="panel panel-default top-div">
						...
						<div class="panel01">
							...
							<form action="<%=basePath%>saveInformationBond.do" id="uploadForm" method="post" onsubmit="return doVaild()" style="margin-top:50px;">
							<input type="hidden" name="ibId"
											value="${informationBond.ibId}">
								...
								<div class="form-group" style="margin-top:5px;text-align: right;">
									...
									<div class="col-xs-9 mtm" style="padding-left:0px;">
										<label class="col-xs-3 control-label" style="width: 120px;line-height:34px;vertical-align: middle;">
										 ...
										 <div class="col-xs-6">
											  <input type="text" name="bondCode" class="form-control" value="${informationBond.bondCode}" />
										 </div>
									</div>
									...
									<div class="col-xs-9 mtm" style="padding-left:0px;">
										...
										<div class="col-xs-6"> 
											<input type="text" name="bondType" class="form-control" value="${informationBond.bondType}" />
										</div>
									</div>
									...
									<div class="col-xs-9 mtm" style="padding-left:0px;">
										...
										<div class="col-xs-6"> 
											<input type="text" name="issuingTerm" id="issuingTerm" class="form-control" value="${informationBond.issuingTerm}" />
										</div>
									</div>
									...
									<div class="col-xs-9 mtm" style="padding-left:0px;">
										...
										<div class="col-xs-6"> 
											<input type="text" name="issuingAmount" class="form-control" value="${informationBond.issuingAmount}" />
										</div>
									</div>
									...
									<div class="col-xs-9 mtm" style="padding-left:0px;">
										...
										<div class="col-xs-6"> 
											<input type="text" name="currentBalance" class="form-control" value="${informationBond.currentBalance}" />
										</div>
									</div>
