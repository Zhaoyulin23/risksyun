					...
					<div class="panel panel-default top-div">
						<div class="panel-heading">
							...
							<a class="btn btn-sm btn-info" style="float: right;color: #fff;"
													href="getInformationIpo.do?ipoId=0&seId=${seId}">新增 </a>
						</div>
										...
										<div>
											<div class="t_resource">
												<table class="table table-striped table-bordered  table-hover table-condensed">
													...
													<tbody>
													 <c:forEach var="ipo" items="${ipo_list}">
														<tr>
															<td>${ipo.exchange}</td>
															<td><fmt:formatDate value="${ipo.ipoDate}" pattern="yyyy-MM-dd"/></td>
															<td>${ipo.ipoCode}</td>
															<td>
																<a class="btn btn-sm btn-info" href="getInformationIpo.do?ipoId=${ipo.ipoId}&seId=${seId}" >修改</a>
																<a class="btn btn-sm btn-info" href="deleteInformationIpo.do?ipoId=${ipo.ipoId}&seId=${seId}">删除</a>
															</td>
														</tr>
														 </c:forEach>
