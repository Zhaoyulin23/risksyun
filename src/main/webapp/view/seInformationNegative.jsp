				...
				<div class="col-xs-10 prn" style="padding-left:0">
					...
					<div class="panel panel-default top-div">
						<div class="panel-heading">
							<a style="cursor: default;">单个企业管理-负面信息 </a>
							<a class="btn btn-sm btn-info" style="float: right;color: #fff;"
													href="getInformationNegative.do?inId=0&seId=${seId}">新增 </a>
						</div>
										...
										<div>
											<div class="t_resource">
												<table class="table table-striped table-bordered  table-hover table-condensed">
													...
													<tbody>
													 <c:forEach var="informationNegative" items="${in_list}">
														<tr>
															<td><fmt:formatDate value="${informationNegative.idDate}" pattern="yyyy-MM-dd"/></td>
															<td>${informationNegative.informationNegativeType.typeName}</td>
															<td>${informationNegative.amount}</td>
															<td>${informationNegative.incident}</td>
															<td>
																<a class="btn btn-sm btn-info" href="getInformationNegative.do?inId=${informationNegative.inId}&seId=${seId}" >修改</a>
																<a class="btn btn-sm btn-info" href="deleteInformationNegative.do?inId=${informationNegative.inId}&seId=${seId}">删除</a>
															</td>
														</tr>
														 </c:forEach>
