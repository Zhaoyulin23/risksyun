					...
					<div class="panel panel-default top-div">
						<div class="panel-heading">
							...
							<a class="btn btn-sm btn-info" style="float: right;color: #fff;"
													href="informationShareholderDetail.do?isId=0&seId=${signleEnterprise.seId}">新增 </a>
						</div>
										...
										<div>
											<div class="t_resource">
												<table class="table table-striped table-bordered  table-hover table-condensed">
													...
													<tbody>
													 <c:forEach var="informationShareholder" items="${is_list}">
														<tr>
															<td><fmt:formatDate value="${informationShareholder.alterTime}" pattern="yyyy-MM-dd"/></td>
															<td>
																<a class="btn btn-sm btn-info" href="informationShareholderDetail.do?isId=${informationShareholder.isId}&seId=${signleEnterprise.seId}" >修改</a>
																<a class="btn btn-sm btn-info" href="deleteInformationShareholder.do?isId=${informationShareholder.isId}&seId=${signleEnterprise.seId}">删除</a>
															</td>
															<td>
																<a class="btn btn-sm btn-info" href="getInformationShareholderDetailList.do?isId=${informationShareholder.isId}&seId=${signleEnterprise.seId}" >股东信息及变更</a>
															</td>
														</tr>
														 </c:forEach>
