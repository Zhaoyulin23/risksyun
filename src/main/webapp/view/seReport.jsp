				...
				<div class="col-xs-10 prn" style="padding-left:0">
					...
					<div class="panel panel-default top-div">
						<div class="panel-heading">
							<a style="cursor: default;">单个企业管理-报告 </a>
										...
										<div>
											<div class="t_resource">
												<table class="table table-striped table-bordered  table-hover table-condensed">
													...
													<tbody>
													 <c:forEach var="seReport" items="${sr_list}">
														<tr>
															<td>${seReport.seReportType.typeName}</td>
															<td>${seReport.arYear}</td>
															<td>${seReport.reportName}</td>
															<td><a href="${seReport.reportUrl}" target="_blank"><p style="width:350px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;course:hand;">${seReport.reportUrl}</p></a></td>
															<td>${seReport.websites}</td>
															<td>
																<a class="btn btn-sm btn-info" href="getSeReport.do?reportId=${seReport.reportId}&seId=${seId}" >修改</a>
																<a class="btn btn-sm btn-info" href="deleteSeReport.do?reportId=${seReport.reportId}&seId=${seId}">删除</a>
															</td>
														</tr>
														 </c:forEach>
